<template>
    <div class="card">
        <div class="card-header">렛플 관리자 메인페이지</div>
        <div class="card-body d-flex">
            <AdminSidebar class="col-lg-1"/>
...
.item1_block .order_todayTotal {
    border-bottom: 1px solid #db4416;
    line-height: 2;
    color: #db4416;
    font-weight: 600;
    font-size: 1.7rem;
...
.item1_block .order_monthTotal {
    border-bottom: 1px solid #0660cf;
    line-height: 2;
    color: #0660cf;
    font-weight: 600;
    font-size: 1.7rem;
...
.item1_block .order_totalSub {
    color: #8d8d8d;
    font-size: 0.9rem;
}

/* item2 block ------------------------------ */
.item2_block .item_tit {
    padding: 20px;
    border: 1px solid #8d8d8d;
    background-color: #f5f5f5;
    text-align: center;
...
.item2_block .order_todayPayTotal {
    border-bottom: 1px solid #db4416;
    line-height: 2;
    color: #db4416;
    font-weight: 600;
...
.item2_block .order_monthPayTotal {
    border-bottom: 1px solid #0660cf;
    line-height: 2;
    color: #0660cf;
    font-weight: 600;
...
.item2_block .order_totalSub {
    color: #8d8d8d;
    font-size: 0.9rem;
}

/* item3 block ------------------------------ */
.item3_block .item_tit {
    padding: 20px;
    border: 1px solid #8d8d8d;
    background-color: #f5f5f5;
    text-align: center;
...
.item3_block .order_todayCancelTotal {
    border-bottom: 1px solid #db4416;
    line-height: 2;
    color: #db4416;
    font-weight: 600;
...
.item3_block .order_monthCancelTotal {
    border-bottom: 1px solid #0660cf;
    line-height: 2;
    color: #0660cf;
    font-weight: 600;
